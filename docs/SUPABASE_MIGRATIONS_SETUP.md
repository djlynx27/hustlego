...
| `SUPABASE_PROJECT_ID` | Ton ID projet Supabase (visible dans Settings → General) |
...
| "Project not found" | Vérifie que `SUPABASE_PROJECT_ID` correspond à ton projet (pas l'URL, juste l'ID) |
