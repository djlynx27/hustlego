...
import { computeDemandScore } from '../lib/scoringEngine';
...
export default function PlanningScreen() {
	...
	const slots = useMemo(() => {
		...
		const weatherCond = weather ? { weatherId: weather.weatherId, temp: weather.temp, demandBoostPoints: weather.demandBoostPoints } : null;
	...
	const scrollAndHighlight = useCallback((time) => {
	...
	const setSlotRef = useCallback((time, el) => {
