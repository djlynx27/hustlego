...
import { useCities, useZones, useAddZone, useUpdateZone, useDeleteZone } from '../hooks/useSupabase';
...
const ZONE_TYPES = ['commercial', 'residential', 'nightlife', 'metro', 'event', 'other'];
const CITY_CENTERS = {
	mtl: [45.5017, -73.5673],
	qc: [46.8139, -71.2080],
	ott: [45.4215, -75.6972],
...
export default function ZonesScreen() {
	...
	const [form, setForm] = useState({ name: '', type: 'commercial', latitude: '', longitude: '' });
