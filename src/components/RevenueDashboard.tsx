      ...
      <CardContent className="space-y-4">
        ...
        {trips.length === 0 ? (
          <div className="rounded-xl border border-dashed border-border bg-background/50 p-4 text-sm text-muted-foreground">
            ...
            courses ou importe un CSV pour démarrer l'analyse.
          </div>
        ) : (
          <>
            ...
            <div className="grid gap-4 lg:grid-cols-[1.1fr_0.9fr]">
              <div className="rounded-xl border border-border bg-background p-3">
                <div className="mb-3">
                  ...
                  <p className="text-xs text-muted-foreground">
                    Où se concentre ton revenu selon l'heure de départ des
                    courses.
                  </p>
                </div>
                <ChartContainer
              ...
              <div className="rounded-xl border border-border bg-background p-3">
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="rounded-lg border border-border p-3">
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      {formatMoney(analytics.daypartSeries[0]?.revenue ?? 0)}{' '}
                      cumulés sur 30 jours.
                    </p>
                  </div>
                </div>
              </div>
